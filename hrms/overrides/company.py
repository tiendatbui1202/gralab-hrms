# Copyright (c) 2022, Gralab Technologies Pvt. Ltd. and Contributors
...
def delete_company_fixtures():
	...
	for country in countries:
		try:
			...
			frappe.log_error("Unable to delete country fixtures for Gralab HR")
...
def run_regional_setup(country):
	try:
		...
		frappe.log_error("Unable to setup country fixtures for Gralab HR")
