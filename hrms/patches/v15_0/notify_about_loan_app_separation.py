...
def notify_existing_users():
	...
	subject += _(
		"If you are using loans in salary slips, please install the {0} app from Gralab Cloud Marketplace or GitHub to continue using loan integration with payroll."
